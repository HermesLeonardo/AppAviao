...
import 'package:appaviao/adapter/adapter_usuario.dart';
...
class _TelaCadastroState extends State<TelaCadastro> {
  ...
  void cadastrar() async {
    if (formKey.currentState!.validate()) {
      ...
      Usuario usuario = UsuarioAdapter.fromDTO(usuarioDTO);

      UsuarioDAO usuarioDAO = UsuarioDAO();
      await usuarioDAO.inserirUsuario(usuario);

      // Após o cadastro, navegue para a tela de perfil passando o usuário como argumento
